...
// ***************************************************************************
// This file does not contain any private configuration options.
...
// outgoing X-Modem data blocks. They're large, but this is the fastest way.
// ---------------------------------------------------------------------------
static CROMDATA BYTE m_acCRCHiArray[] = {
...
static CROMDATA BYTE m_acCRCLoArray[] = {
...
{
  BYTE cChksum = 0;
#if USE_HOSTIF_PAYLOAD_CHECKSUM    
  WORD wI;
