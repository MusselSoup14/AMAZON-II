...
#include <usb_host/part.h>

#include <usb_host/usb_defs.h>
...
#endif
/* routines */
int usb_host_init(void); /* initialize the USB Controller */
int usb_host_stop(void); /* stop the USB Controller */
int UsbMemInit(void);
int UsbMemScan(void);
//int UsbHostInit(void);
int usbhostinit(void);
//int GetUsbStorageDetected(void);
int get_usb_storage_detected(void);
//int GetUsbStorageRemoved(void);
